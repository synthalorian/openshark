...
pub async fn register_commands(
    ...
    let commands = vec![
        ...
        CreateCommand::new("system")
            ...
            .add_option(
                CreateCommandOption::new(CommandOptionType::String, "prompt", "The system prompt to use")
                    .required(true),
            ),

        CreateCommand::new("reset")
            .description("Reset to default system prompt and clear history"),
        ...
        CreateCommand::new("settings")
            ...
            .add_option(
                CreateCommandOption::new(CommandOptionType::String, "key", "Setting key (typing_indicator, max_history, require_mention)")
                    .required(false),
            )
            .add_option(
