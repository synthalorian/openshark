...
fn detect_natural_language(text: &str, out: &mut Vec<ToolSuggestion>) {
    ...
    let tool_names = [
        "edit", "fs", "git", "lsp", "refactor", "search", "grep", "terminal", "test_runner",
        "web", "browser", "x_search", "vision", "image_gen", "video", "video_gen", "tts",
        "memory", "session_search", "context_engine", "todo", "cronjob", "skills",
        "messaging", "homeassistant", "spotify", "yuanbao", "computer_use",
        "moa", "delegation", "clarify", "code_execution",
    ];
